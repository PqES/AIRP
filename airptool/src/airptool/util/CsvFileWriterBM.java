...
public class CsvFileWriterBM {
	...
	//CSV file header
	private static final String FILE_HEADER = "id,id2,bloco,metodo,classe,pacote,blocoDoMetodo,a,b,c,d,tipo";
	
	//private static List<CsvDataBM> csvdatasBM = new ArrayList<CsvDataBM>();

	//public static void addCsvDataBM(List<CsvDataBM> csvdataBM){
	//	csvdatasBM.addAll(csvdataBM);
	//}
	
	public static void writeCsvFileBM(List<CsvDataBM> csvdataBM) {
		...
		*/
		...
		try {
			fileWriter = new FileWriter("/Users/arthurfp/Desktop/dataBM.csv", true);
			...
			for (CsvDataBM csvdBM : csvdataBM) {
				...
				fileWriter.append(String.valueOf(csvdBM.getId2()));
				fileWriter.append(COMMA_DELIMITER);
				fileWriter.append(String.valueOf(csvdBM.getBloco()));
				fileWriter.append(COMMA_DELIMITER);
				...
				fileWriter.append(COMMA_DELIMITER);
				fileWriter.append(String.valueOf(csvdBM.getBlocoDoMetodo()));
				fileWriter.append(COMMA_DELIMITER);
