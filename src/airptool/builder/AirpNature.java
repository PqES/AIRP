...
public class AirpNature implements IProjectNature {
	 ...
	 */
	public static final String NATURE_ID = "airptool.airpNature";
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(AirpBuilder.BUILDER_ID)) {
				return;
			}
		}
		...
		command.setBuilderName(AirpBuilder.BUILDER_ID);
